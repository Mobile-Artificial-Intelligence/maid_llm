...
struct sampling_params {
    ...
    int         n_probs               = 0;          // if greater than 0, output the probabilities of top n_probs tokens.
    int         min_keep              = 0;          // 0 = disabled, otherwise samplers should return at least min_keep tokens
