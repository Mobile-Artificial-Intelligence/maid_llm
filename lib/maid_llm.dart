...
import 'maid_llm_bindings_generated.dart';
...
const String _libName = 'maid_llm';

/// The dynamic library in which the symbols for [MaidLlmBindings] can be found.
...
final MaidLlmBindings _bindings = MaidLlmBindings(_dylib);
