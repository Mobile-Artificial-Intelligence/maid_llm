...
class maid_llm {
  ...
  double maid_llm_load_model(
    ffi.Pointer<maid_llm_params> cparams,
  ) {
    return _maid_llm_load_model(
      cparams,
    );
  }

  late final _maid_llm_load_modelPtr = _lookup<
          ffi
          .NativeFunction<ffi.Double Function(ffi.Pointer<maid_llm_params>)>>(
      'maid_llm_load_model');
  late final _maid_llm_load_model = _maid_llm_load_modelPtr
      .asFunction<double Function(ffi.Pointer<maid_llm_params>)>();

  int maid_llm_prompt(
    ffi.Pointer<maid_llm_params> cparams,
    ffi.Pointer<maid_llm_chat> chat,
    ffi.Pointer<dart_outputs> output,
  ) {
  ...
  late final _maid_llm_promptPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<maid_llm_params>,
              ffi.Pointer<maid_llm_chat>,
              ffi.Pointer<dart_outputs>)>>('maid_llm_prompt');
  late final _maid_llm_prompt = _maid_llm_promptPtr.asFunction<
      int Function(ffi.Pointer<maid_llm_params>, ffi.Pointer<maid_llm_chat>,
          ffi.Pointer<dart_outputs>)>();
...
abstract class ggml_type {
  ...
  static const int GGML_TYPE_COUNT = 29;
}
...
final class dart_outputs extends ffi.Struct {
  external ffi.Pointer<log_output> log;

  external ffi.Pointer<chat_output> chat;
}
