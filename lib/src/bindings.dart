...
class maid_llm {
  ...
  int maid_llm_init(
    ...
    ffi.Pointer<log_output> log_output,
  ) {
  ...
  late final _maid_llm_init = _maid_llm_initPtr.asFunction<
      int Function(ffi.Pointer<gpt_c_params>, ffi.Pointer<log_output>)>();
  ...
  late final _maid_llm_promptPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<maid_llm_chat>, ffi.Pointer<chat_output>,
              ffi.Pointer<log_output>)>>('maid_llm_prompt');
  late final _maid_llm_prompt = _maid_llm_promptPtr.asFunction<
      int Function(ffi.Pointer<maid_llm_chat>, ffi.Pointer<chat_output>,
          ffi.Pointer<log_output>)>();
