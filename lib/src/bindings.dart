...
class lcpp {
  ...
  late final _llama_attach_threadpoolPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<llama_context>, ffi.Int,
              ffi.Int)>>('llama_attach_threadpool');
  ...
  int llama_model_rope_type(
    ffi.Pointer<llama_model> model,
  ) {
    return _llama_model_rope_type(
      model,
    );
  }
  ...
  int llama_vocab_get_attr(
    ffi.Pointer<llama_vocab> vocab,
    int token,
  ) {
    return _llama_vocab_get_attr(
      vocab,
      token,
    );
  }
...
abstract class llama_rope_type {
  ...
  static const int LLAMA_ROPE_TYPE_NEOX = 1;
  static const int LLAMA_ROPE_TYPE_MROPE = 2;
  static const int LLAMA_ROPE_TYPE_VISION = 3;
}
...
final class llama_model_params extends ffi.Struct {
  external ffi.Pointer<ffi.Int> devices;
...
abstract class ggml_numa_strategy1 {
